...
chown -R ${USER_ID}:${GROUP_ID} /var/www/storage /var/www/bootstrap/cache || echo "Some files could not be changed"
chmod -R 775 /var/www/storage /var/www/bootstrap/cache || echo "Some permissions could not be changed"
